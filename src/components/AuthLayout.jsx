            ...
            <div className="mt-8 space-y-6 border-t border-indigo-500 pt-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-200">Mendukung penyampaian edukasi kesehatan kepada masyarakat.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-indigo-500 text-white p-3 rounded-full flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-200">Menyediakan data kesehatan warga berbasis RT/RW untuk perencanaan.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-indigo-500 text-white p-3 rounded-full flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-200">Meningkatkan kapasitas kader dalam pengelolaan data digital.</p>
                </div>
              </div>
            </div>
          </div>
