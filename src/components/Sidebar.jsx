...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 bg-slate-800 text-slate-300 w-64 transform transition-transform duration-300 ease-in-out z-30 flex flex-col
        ${
      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          <NavLink
            to="/dashboard"
            className={({ isActive }) =>
              `flex items-center px-4 py-2.5 rounded-lg transition duration-200 hover:bg-slate-700 ${
          ...
          <p className="px-4 pt-4 pb-2 text-xs font-semibold text-slate-500 uppercase">
            Input Data
          </p>
          <NavLink
            to="/dashboard/sigita"
