...
const Sidebar = ({ setPageTitle }) => {
  const { userProfile } = useContext(AuthContext); // Ambil profil pengguna
  ...
  return (
    <aside className="fixed inset-y-0 left-0 bg-slate-800 text-slate-300 w-64 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-30 flex flex-col">
      {/* Sidebar Header */}
